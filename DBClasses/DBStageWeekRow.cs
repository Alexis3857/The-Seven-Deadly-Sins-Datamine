public class DBStageWeekRow
{
    ...
    public int CoinopenKeyRating
    {
        get
        {
            return coinopen_key_rating;
        }
    }

    public string CoinopenKeyIcon
    {
        get
        {
            return coinopen_key_icon;
        }
    }

    public int CoinopenKeyCount
    {
        get
        {
            return coinopen_key_count;
        }
    }

    public int CoinopenWeeklymax
    {
        get
        {
            return coinopen_weeklymax;
        }
    }
    ...
    public int PlayRewardGaugePoint
    {
        get
        {
            return play_reward_gauge_point;
        }
    }

    public int NeedKeyItemId
    {
        get
        {
            return need_key_item_id;
        }
    }
    ...
    public int NeedKeyCount
    {
        get
        {
            return need_key_count;
        }
    }

    public int TimelimitOpenKey
    {
        get
        {
            return timelimit_open_key;
        }
    }

    public int TimelimitOpenKeyCount
    {
        get
        {
            return timelimit_open_key_count;
        }
    }
    ...
    public int RewardValueBox6
    {
        get
        {
            return reward_value_box_6;
        }
    }
    ...
    public int RewardValue7
    {
        get
        {
            return reward_value_7;
        }
    }
    ...
    public int RewardValueBox8
    {
        get
        {
            return reward_value_box_8;
        }
    }
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        coinopen_key_rating = reader.ReadInt32();
        coinopen_key_icon = reader.ReadString();
        coinopen_key_count = reader.ReadInt32();
        coinopen_weeklymax = reader.ReadInt32();
        time_limit = reader.ReadInt32();
        ...
        timelimit_open_key = reader.ReadInt32();
        timelimit_open_key_count = reader.ReadInt32();
    ...
    private int coinopen_key_rating;

    private string coinopen_key_icon;

    private int coinopen_key_count;

    private int coinopen_weeklymax;
    ...
    private int play_reward_gauge_point;

    private int need_key_item_id;

    private int need_key_count;

    private int timelimit_open_key;

    private int timelimit_open_key_count;
