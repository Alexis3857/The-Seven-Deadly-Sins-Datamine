public class DBStageYggdrasilTowerRow
{
    ...
    public int YggdrasilIndex
    {
        get
        {
            return yggdrasil_index;
        }
    }
    ...
    public int NeedQuestNorId
    {
        get
        {
            return need_quest_nor_id;
        }
    }
    ...
    private int section_group;

    private int world_group;
    ...
    private int yggdrasil_index;

    private int region;

    private int area;

    private int need_quest_nor_id;
