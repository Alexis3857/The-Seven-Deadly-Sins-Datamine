public class DBCoinShopRow
{
    ...
    public int PeriodBuyLimitedType
    {
        get
        {
            return period_buy_limited_type;
        }
    }
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        event_product = reader.ReadInt32();
        price_coin_item_sub_type = reader.ReadInt32();
        period_buy_limited_type = reader.ReadInt32();
    ...
    private int event_product;

    private int price_coin_item_sub_type;

    private int period_buy_limited_type;
