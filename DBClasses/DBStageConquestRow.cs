public class DBStageConquestRow
{
    ...
    public int AppearCutsceneSkip
    {
        get
        {
            return appear_cutscene_skip;
        }
    }
    ...
    public int RewardHeroLv1
    {
        get
        {
            return reward_hero_lv_1;
        }
    }
    ...
    public int FirstRewardHeroLv
    {
        get
        {
            return first_reward_hero_lv;
        }
    }
    ...
    public List<int> ListRewardHeroLv
    {
        get
        {
            if (list_reward_hero_lv == null)
            {
                list_reward_hero_lv = new List<int>
                {
                    RewardHeroLv1
                };
            }
            return list_reward_hero_lv;
        }
    }
    ...
    private int reward_hero_lv_1;

    private int first_reward_id;

    private int first_reward_value;

    private int first_reward_hero_lv;
    ...
    private List<int> list_reward_hero_lv;
