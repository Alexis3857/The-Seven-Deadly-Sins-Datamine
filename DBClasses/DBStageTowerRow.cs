public class DBStageTowerRow
{
    ...
    public byte BossStageCheck
    {
        get
        {
            return boss_stage_check;
        }
    }
    ...
    private byte boss_stage_check;

    private byte save_point;
