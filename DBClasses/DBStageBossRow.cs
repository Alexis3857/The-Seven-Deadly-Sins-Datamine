public class DBStageBossRow
{
    ...
    public int DestroyGaugeMin
    {
        get
        {
            return destroy_gauge_min;
        }
    }

    public int DestroyGaugeMax
    {
        get
        {
            return destroy_gauge_max;
        }
    }

    public int DestroyGaugeUnit
    {
        get
        {
            return destroy_gauge_unit;
        }
    }

    public int DestroyGaugeBonus
    {
        get
        {
            return destroy_gauge_bonus;
        }
    }
    ...
    private int destroy_gauge_min;

    private int destroy_gauge_max;

    private int destroy_gauge_unit;

    private int destroy_gauge_bonus;
