public class DBStageFinalBossRow
{
    ...
    public int FinalBossPointGroupId
    {
        get
        {
            return final_boss_point_group_id;
        }
    }
    ...
    public int NeedOpenItemId
    {
        get
        {
            return need_open_item_id;
        }
    }

    public int NeedOpenCount
    {
        get
        {
            return need_open_count;
        }
    }
    ...
    public int ClearItemBox
    {
        get
        {
            return clear_item_box;
        }
    }
    ...
    public int ClearRewardId
    {
        get
        {
            return clear_reward_id;
        }
    }

    public int ClearRewardValue
    {
        get
        {
            return clear_reward_value;
        }
    }
    ...
    public List<int> ListArrayFinalBossTag
    {
        get
        {
            return list_array_final_boss_tag;
        }
    }
    ...
    public List<int> ListPhase1ArrayBossEffectId
    {
        get
        {
            return list_phase1_array_boss_effect_id;
        }
    }

    public List<int> ListPhase1ArrayBossEffectMatchingId
    {
        get
        {
            return list_phase1_array_boss_effect_matching_id;
        }
    }
    ...
    public List<int> ListPhase2ArrayBossEffectId
    {
        get
        {
            return list_phase2_array_boss_effect_id;
        }
    }

    public List<int> ListPhase2ArrayBossEffectMatchingId
    {
        get
        {
            return list_phase2_array_boss_effect_matching_id;
        }
    }
    ...
    public List<int> ListPhase3ArrayBossEffectId
    {
        get
        {
            return list_phase3_array_boss_effect_id;
        }
    }

    public List<int> ListPhase3ArrayBossEffectMatchingId
    {
        get
        {
            return list_phase3_array_boss_effect_matching_id;
        }
    }
    ...
    public int BossCinemaType
    {
        get
        {
            return boss_cinema_type;
        }
    }
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        list_array_final_boss_tag = new List<int>();
        for (int i = 0; i < num; i++)
        {
            list_array_final_boss_tag.Add(reader.ReadInt32());
        }
        ...
        list_phase1_array_boss_effect_id = new List<int>();
        for (int j = 0; j < num2; j++)
        {
            list_phase1_array_boss_effect_id.Add(reader.ReadInt32());
        }
        int num3 = reader.ReadInt32();
        list_phase1_array_boss_effect_matching_id = new List<int>();
        for (int k = 0; k < num3; k++)
        {
            list_phase1_array_boss_effect_matching_id.Add(reader.ReadInt32());
        }
        ...
        list_phase2_array_boss_effect_id = new List<int>();
        for (int num8 = 0; num8 < num7; num8++)
        {
            list_phase2_array_boss_effect_id.Add(reader.ReadInt32());
        }
        int num9 = reader.ReadInt32();
        list_phase2_array_boss_effect_matching_id = new List<int>();
        for (int num10 = 0; num10 < num9; num10++)
        {
            list_phase2_array_boss_effect_matching_id.Add(reader.ReadInt32());
        }
        ...
        list_phase3_array_boss_effect_id = new List<int>();
        for (int num18 = 0; num18 < num17; num18++)
        {
            list_phase3_array_boss_effect_id.Add(reader.ReadInt32());
        }
        int num19 = reader.ReadInt32();
        list_phase3_array_boss_effect_matching_id = new List<int>();
        for (int num20 = 0; num20 < num19; num20++)
        {
            list_phase3_array_boss_effect_matching_id.Add(reader.ReadInt32());
        }
    ...
    private int final_boss_point_group_id;
    ...
    private int need_open_item_id;

    private int need_open_count;
    ...
    private int clear_item_box;

    private int clear_reward_id;

    private int clear_reward_value;
    ...
    private List<int> list_array_final_boss_tag;

    private int limit_contents_match_passive_group;

    private int phase1_monster_ai_id;

    private int phase1_image;

    private List<int> list_phase1_array_boss_effect_id;

    private List<int> list_phase1_array_boss_effect_matching_id;
    ...
    private int phase2_image;

    private List<int> list_phase2_array_boss_effect_id;

    private List<int> list_phase2_array_boss_effect_matching_id;
    ...
    private int phase3_image;

    private List<int> list_phase3_array_boss_effect_id;

    private List<int> list_phase3_array_boss_effect_matching_id;
