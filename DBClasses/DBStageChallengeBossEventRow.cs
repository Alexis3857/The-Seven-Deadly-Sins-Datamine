public class DBStageChallengeBossEventRow
{
    ...
    public string ChallengeBossPatternPhase01Desc
    {
        get
        {
            return challenge_boss_pattern_phase01_desc;
        }
    }

    public string ChallengeBossPatternPhase02Desc
    {
        get
        {
            return challenge_boss_pattern_phase02_desc;
        }
    }
    ...
    public int RewardValueBox
    {
        get
        {
            return reward_value_box;
        }
    }
    ...
    private string challenge_boss_pattern_phase01_desc;

    private string challenge_boss_pattern_phase02_desc;
