public class DBStageAncientRow
{
    public int Id
    {
        get
    ...
    public string Bancondition7
    {
        get
        {
            return BanCondition_7;
        }
    }

    public int Banconditionvalue7
    {
        get
        {
            return BanConditionValue_7;
        }
    }
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        camp_type = reader.ReadInt32();
        battle_type = reader.ReadInt32();
        ...
        camp_donation = reader.ReadInt32();
        ...
        BanCondition_7 = reader.ReadString();
        BanConditionValue_7 = reader.ReadInt32();
    ...
    private string BanCondition_7;

    private int BanConditionValue_7;
