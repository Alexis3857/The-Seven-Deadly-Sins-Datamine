public class DBStepupGambleBonusRewardRow
{
    ...
    public int BonusRewardRotationIndex
    {
        get
        {
            return bonus_reward_rotation_index;
        }
    }
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        bonus_reward_rotation_index = reader.ReadInt32();
    ...
    private int bonus_reward_rotation_index;
