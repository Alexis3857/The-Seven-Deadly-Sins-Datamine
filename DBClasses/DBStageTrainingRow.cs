public class DBStageTrainingRow
{
    ...
    public int StageEndCharacterArea
    {
        get
        {
            return stage_end_character_area;
        }
    }

    public int AmberNpcId
    {
        get
        {
            return amber_npc_id;
    ...
    public int TrainingBattleType
    {
        get
        {
            return training_battle_type;
        }
    }
    ...
    public int FixRewardId
    {
        get
        {
            return fix_reward_id;
        }
    }

    public int FixRewardCount
    {
        get
        {
            return fix_reward_count;
        }
    }

    public int FixRewardBox
    {
        get
        {
            return fix_reward_box;
        }
    }
    ...
    private int stage_end_character_area;

    private int amber_npc_id;

    private string amber_icon;

    private string amber_type;

    private int training_battle_type;
    ...
    private int fix_reward_id;

    private int fix_reward_count;

    private int fix_reward_box;
