public class DBGuildWarLowPointRewardRow
{
    public int Id
    {
        get
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        point_value_min = reader.ReadInt32();
        point_value_max = reader.ReadInt32();
    ...
    private int point_value_min;

    private int point_value_max;
