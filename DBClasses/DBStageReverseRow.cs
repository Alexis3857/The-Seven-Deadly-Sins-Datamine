public class DBStageReverseRow
{
    ...
    public int ServerStageIndex
    {
        get
        {
            return server_stage_index;
        }
    }
    ...
    public string EssenHeroPotraitBase1
    {
        get
        {
            return essen_hero_potrait_base_1;
        }
    }

    public string EssenHeroIcon1
    {
        get
        {
            return essen_hero_icon_1;
        }
    }

    public string EssenHeroPotraitBase2
    {
        get
        {
            return essen_hero_potrait_base_2;
        }
    }

    public string EssenHeroIcon2
    {
        get
        {
            return essen_hero_icon_2;
        }
    }

    public string EssenHeroPotraitBase3
    {
        get
        {
            return essen_hero_potrait_base_3;
        }
    }

    public string EssenHeroIcon3
    {
        get
        {
            return essen_hero_icon_3;
        }
    }

    public string EssenHeroPotraitBase4
    {
        get
        {
            return essen_hero_potrait_base_4;
        }
    }

    public string EssenHeroIcon4
    {
        get
        {
            return essen_hero_icon_4;
        }
    }
    ...
    public List<string> ListEssenHeroPotraitBase
    {
        get
        {
            if (list_essen_hero_potrait_base == null)
            {
                list_essen_hero_potrait_base = new List<string>
                {
                    EssenHeroPotraitBase1,
                    EssenHeroPotraitBase2,
                    EssenHeroPotraitBase3,
                    EssenHeroPotraitBase4
                };
            }
            return list_essen_hero_potrait_base;
        }
    }

    public List<string> ListEssenHeroIcon
    {
        get
        {
            if (list_essen_hero_icon == null)
            {
                list_essen_hero_icon = new List<string>
                {
                    EssenHeroIcon1,
                    EssenHeroIcon2,
                    EssenHeroIcon3,
    ...
    private int server_stage_index;
    ...
    private string essen_hero_potrait_base_1;

    private string essen_hero_icon_1;

    private string essen_hero_potrait_base_2;

    private string essen_hero_icon_2;

    private string essen_hero_potrait_base_3;

    private string essen_hero_icon_3;

    private string essen_hero_potrait_base_4;

    private string essen_hero_icon_4;
    ...
    private List<string> list_essen_hero_potrait_base;

    private List<string> list_essen_hero_icon;
