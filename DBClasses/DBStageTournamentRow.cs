public class DBStageTournamentRow
{
    public int Id
    {
        get
    ...
    public int EventStageGuageMin
    {
        get
        {
            return event_stage_guage_min;
        }
    }

    public int EventStageGuageMax
    {
        get
        {
            return event_stage_guage_max;
        }
    }

    public int EventStageGuageBonus
    {
        get
        {
            return event_stage_guage_bonus;
        }
    }
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        enemy_string = reader.ReadInt32();
        essen_hero_setting = reader.ReadInt32();
        group_id = reader.ReadInt32();
        team_id = reader.ReadInt32();
        server_stage_index = reader.ReadInt32();
        need_stage_id = reader.ReadInt32();
        event_stage_guage_min = reader.ReadInt32();
        event_stage_guage_max = reader.ReadInt32();
        event_stage_guage_bonus = reader.ReadInt32();
    ...
    private int event_stage_guage_min;

    private int event_stage_guage_max;

    private int event_stage_guage_bonus;
