public class DBStageMazeRow
{
    ...
    public int NeedRechallengeItemId
    {
        get
        {
            return need_rechallenge_item_id;
        }
    }

    public int NeedRechallengeCount
    {
        get
        {
            return need_rechallenge_count;
    ...
    public bool ReadToStream(BinaryReader reader)
    {
        ...
        need_rechallenge_item_id = reader.ReadInt32();
        need_rechallenge_count = reader.ReadInt32();
    ...
    private int need_rechallenge_item_id;

    private int need_rechallenge_count;
